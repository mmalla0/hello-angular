  ...
  ngOnInit() {
    this.products = [
      ...
      },
      {
        ...
        storeQuantity: 30,
        pictures: ['gravity_adjusting_implants.jpg'],
      ...
      },
      {
        ...
        bestBeforeDate: '-',
        storeQuantity: 20,
        pictures: ['toolbox_spaceship_repair.jpg'],
        categories: ['Equipment'],
      },
      {
        id: 8,
        ...
        storeQuantity: 30,
        pictures: ['underwaterbreathing_implants.jpg'],
        categories: ['Equipment'],
      },
      {
        id: 9,
